                  ...
                  >
                    ...
                    <div className="divide-y divide-gray-200">
                      {chargerGroup.slots.map((slot) => (
                        <article
                          key={slot.slot_id}
                          className="grid grid-cols-1 gap-3 px-4 py-4 transition-colors hover:bg-gray-50 md:grid-cols-[minmax(0,1.2fr)_minmax(0,1fr)_minmax(0,1.2fr)_auto] md:items-center"
                        >
